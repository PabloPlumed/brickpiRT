...
static const _Button_type_support_symbol_names_t _Button_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ev3_sensor_msgs, msg, Button)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ev3_sensor_msgs, msg, Button)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ev3_sensor_msgs, msg, Button)() {
  return &::ev3_sensor_msgs::msg::rosidl_typesupport_c::Button_message_type_support_handle;
}
