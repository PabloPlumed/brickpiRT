...
static const _Color_type_support_symbol_names_t _Color_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ev3_sensor_msgs, msg, Color)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ev3_sensor_msgs, msg, Color)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ev3_sensor_msgs, msg, Color)() {
  return &::ev3_sensor_msgs::msg::rosidl_typesupport_c::Color_message_type_support_handle;
}
