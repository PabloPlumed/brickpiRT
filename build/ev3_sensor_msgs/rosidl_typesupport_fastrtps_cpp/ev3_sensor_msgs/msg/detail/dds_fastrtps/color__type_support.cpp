...
#include "ev3_sensor_msgs/msg/detail/color__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ev3_sensor_msgs::msg::Color & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ev3_sensor_msgs::msg::Color & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ev3_sensor_msgs::msg::Color;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ev3_sensor_msgs::msg::Color *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ev3_sensor_msgs::msg::Color *>(
    untyped_ros_message);
...
{
  return &ev3_sensor_msgs::msg::typesupport_fastrtps_cpp::_Color__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ev3_sensor_msgs, msg, Color)() {
  return &ev3_sensor_msgs::msg::typesupport_fastrtps_cpp::_Color__handle;
}
