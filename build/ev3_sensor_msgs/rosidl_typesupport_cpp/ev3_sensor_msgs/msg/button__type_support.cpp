...
static const _Button_type_support_symbol_names_t _Button_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ev3_sensor_msgs, msg, Button)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ev3_sensor_msgs, msg, Button)),
  }
};
...
{
  return &::ev3_sensor_msgs::msg::rosidl_typesupport_cpp::Button_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ev3_sensor_msgs, msg, Button)() {
  return get_message_type_support_handle<ev3_sensor_msgs::msg::Button>();
}
