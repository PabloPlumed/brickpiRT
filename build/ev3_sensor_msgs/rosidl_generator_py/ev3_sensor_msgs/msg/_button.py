...
class Metaclass_Button(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ev3_sensor_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ev3_sensor_msgs.msg.Button')
            logger.debug(
    ...
    def RELEASED(self):
        ...
        return Metaclass_Button.__constants['RELEASED']

    @property
    def PRESSED(self):
        """Message constant 'PRESSED'."""
        return Metaclass_Button.__constants['PRESSED']
