...
: ${AMENT_CURRENT_PREFIX:="/code/brickpi/rt_ros2/install/rt_ros2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rt_ros2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rt_ros2/environment/path.sh"
